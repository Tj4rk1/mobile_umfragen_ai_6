...
values
  ('media_image_no_ai', 'Aurelis', 'Premiummarke', 'Mehr Ruhe fuer deine Haut.', 'Bildmotiv der Markenkommunikation.', null, 'aurelis_premium.png'),
  ('media_image_ai', 'Aurelis', 'Premiummarke', 'Mehr Ruhe fuer deine Haut.', 'Bildmotiv der Markenkommunikation.', null, 'aurelis_premium.png'),
  ...
  ('brand_fmcg_no_ai', 'Aurelis Daily', 'FMCG / Alltagsmarke', 'Pflege, die jeden Tag einfach funktioniert.', 'Aurelis Daily bietet unkomplizierte Hautpflege fuer die taegliche Routine. Leicht verstaendlich, angenehm in der Anwendung und gemacht fuer ein frisches Hautgefuehl im Alltag.', null, 'aurelis_premium.png'),
  ('brand_fmcg_ai', 'Aurelis Daily', 'FMCG / Alltagsmarke', 'Pflege, die jeden Tag einfach funktioniert.', 'Aurelis Daily bietet unkomplizierte Hautpflege fuer die taegliche Routine. Leicht verstaendlich, angenehm in der Anwendung und gemacht fuer ein frisches Hautgefuehl im Alltag.', null, 'aurelis_premium.png'),
  ('brand_premium_no_ai', 'Aurelis', 'Premiummarke', 'Mehr Ruhe fuer deine Haut.', 'Aurelis verbindet hochwertige Formulierungen mit einer Pflegeroutine, die sich bewusst und angenehm anfuehlt. Fuer Haut, die gepflegter, ausgeglichener und frischer wirken soll.', null, 'aurelis_premium.png'),
  ('brand_premium_ai', 'Aurelis', 'Premiummarke', 'Mehr Ruhe fuer deine Haut.', 'Aurelis verbindet hochwertige Formulierungen mit einer Pflegeroutine, die sich bewusst und angenehm anfuehlt. Fuer Haut, die gepflegter, ausgeglichener und frischer wirken soll.', null, 'aurelis_premium.png'),
  ('brand_luxury_no_ai', 'Aurelis Maison', 'Luxusmarke', 'Rituale fuer Hautpflege mit besonderem Anspruch.', 'Aurelis Maison inszeniert Pflege als exklusives Ritual. Edle Formulierungen, ausgewaehlte Inhaltsstoffe und eine reduzierte Markenwelt schaffen ein Gefuehl von Wertigkeit, Ruhe und Besonderheit.', null, 'aurelis_premium.png'),
